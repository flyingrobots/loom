# Chapter 1 — Computation Is Transformation
...
This is the moment where CΩMPUTER really begins.
...
#### 1.4.1 The Physics Engine That Looked Suspiciously Like a Compiler
...
CΩMPUTER doesn’t try to redefine physics.
