...
Well, at the time, I was on this "make Git do things Git isn't supposed to do" kick. What if we turned Git into a distributed key-value store? A semantic graph database? A deployment ledger?
